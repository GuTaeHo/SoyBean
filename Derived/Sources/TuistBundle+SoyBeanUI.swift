...
/// Since SoyBeanUI is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "SoyBean_SoyBeanUI"
    var candidates = [
    ...
    fatalError("unable to find bundle named SoyBean_SoyBeanUI")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class SoyBeanUIResources: NSObject {
